package com.campusflow.capacity.config;
...
/**
 * Capacity-service'in kullandığı Kafka topic'lerini uygulama başlangıcında otomatik oluşturur.
 * Eğer topic zaten varsa atlanır.
 *
 * Consumer container factory: StringDeserializer + StringJsonMessageConverter kullanarak
 * her @KafkaListener metodunun @Payload parametre tipine göre otomatik JSON dönüşümü sağlar.
 */
@Configuration
